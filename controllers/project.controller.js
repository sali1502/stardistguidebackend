...
async function createDefaultChecklists(projectId) {
  const defaultChecklists = {
    designer: [
      ...
      { title: '1.4.3 Färgkontraster för text', content: 'Text måste ha minst 4.5:1 kontrast mot bakgrund (3:1 för stor text) - Digg: https://www.digg.se/webbriktlinjer/alla-webbriktlinjer/anvand-tillracklig-kontrast-mellan-text-och-bakgrund' },
      { title: '1.4.11 Färgkontraster för grafik', content: 'Grafiska element och UI-komponenter måste ha minst 3:1 kontrast - Digg: https://www.digg.se/webbriktlinjer/alla-webbriktlinjer/anvand-tillrackliga-kontraster-i-komponenter-och-grafik ' },
      ...
      { title: '3.3.2 Etiketter och ledtexter', content: 'Designa tydliga etiketter (labels) och instruktioner för formulärfält - Digg: https://www.digg.se/webbriktlinjer/alla-webbriktlinjer/skapa-tydliga-faltetiketter-ledtexter' },
    ...
    developer: [
      ...
      { title: '2.1.1 Tangentbordsnavigering', content: 'All funktionalitet ska vara åtkomlig via tangentbord - Digg: https://www.digg.se/webbriktlinjer/alla-webbriktlinjer/all-funktionalitet-ska-kunna-anvandas-med-tangentbord' },
      ...
      { title: '1.3.5 Formulärfält', content: 'Använd autocomplete-attribut för vanliga formulärfält - Digg: https://www.digg.se/webbriktlinjer/alla-webbriktlinjer/ange-syftet-for-formularfalt-i-koden' },
      { title: '2.2.1 Förläng tidsgränser', content: 'Ge användare möjlighet att förlänga tidsgränser - Digg: https://www.digg.se/webbriktlinjer/alla-webbriktlinjer/gor-det-mojligt-att-justera-tidsbegransningar' },
      ...
      { title: '3.3.4 Granska och bekräfta', content: 'Låt användare granska/bekräfta viktig information - Digg: https://www.digg.se/webbriktlinjer/alla-webbriktlinjer/ge-mojlighet-att-angra-korrigera-eller-bekrafta-vid-viktiga-transaktioner' },
      ...
      { title: '1.2.2 Textning (video)', content: 'Videor ska ha textning för förinspelat innehåll - Digg: https://www.digg.se/webbriktlinjer/alla-webbriktlinjer/texta-ljudet-i-inspelade-filmer' }
    ],
    tester: [
      ...
      { title: 'Genomgång av resultat', content: 'Åtgärdsplan framtagen för identifierade problem' },
      { title: 'Status bekräftad', content: 'Tidigare åtgärder är verifierade som genomförda' }
